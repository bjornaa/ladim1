...
# Lon/lat lines
ax.contour(Xcell, Ycell, lat, levels=range(54, 61), colors="black", linestyles=":")
ax.contour(Xcell, Ycell, lon, levels=range(0, 14, 2), colors="black", linestyles=":")
...
plt.plot([135, 172, 172, 135, 135], [42, 42, 81, 81, 42], color="black")
